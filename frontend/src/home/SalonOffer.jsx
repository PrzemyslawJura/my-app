...
return (
    <>
        ...
        <p className="mt-1 truncate text-xs leading-5 text-gray-500">Ocena: {person.star}</p>
        <p className="mt-1 truncate text-xs leading-5 text-gray-500">Liczba recenzji: {person.countOfReviews}</p>
        <p className="mt-1 truncate text-xs leading-5 text-gray-500">Odległość: {person.distance} km</p>
        </div>
        </div>
