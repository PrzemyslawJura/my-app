...
const searchLocation = (value) =>
{
  ...
  return (
      <Combobox value={selected} onChange={setSelected}>
        {searchLocation(selected.cityName)}
        <div className="relative mt-1 w-full  border-gray-600 border rounded-md">
          ...
          <Combobox.Button className="absolute inset-y-0 left-2 flex items-center pr-2">
            ...
            <Combobox.Input
              ...
              displayValue={search ? search : (location) => location.cityName}
          ...
          <Transition
            ...
            afterLeave={() => setQuery('')}
          >
            <Combobox.Options className="absolute mt-1 max-h-60 w-full overflow-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm z-[100]">
