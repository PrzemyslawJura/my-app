...
export default function Location({setSearch}) {
 ...
 //     const reqData = await fetch("https://localhost:7230/api/City/City");
 ...
 // })
  ...
  useEffect(() => {
    fetch('https://localhost:7230/api/City/City')
      .then((res) => res.json())
      .then((result) => {
        console.log(result);
        ...
        <div className="relative mt-1 w-full  border-gray-600 border rounded-md">
          ...
          <Combobox.Button className="absolute inset-y-0 left-2 flex items-center pr-2">
            ...
            <Combobox.Input
              ...
              displayValue={(person) => person.cityName}
