export default function Hairdresser({person}) {
    return (
      <>
          <div className="flex min-w-0 gap-x-4 bg-slate-200">
            <img className="h-16 w-16 flex-none rounded-full bg-gray-50 object-cover" src={process.env.PUBLIC_URL + "/Photos/" + person.salonId + "/" + "photo" + person.id + ".jpg"} alt="" />
