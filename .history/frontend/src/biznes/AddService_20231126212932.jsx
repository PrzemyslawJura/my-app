...
const AddService = ({ setIsShown, workers }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch('https://localhost:7230/Salons/AddService', {
        method: 'POST',
          ...
          <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="flex items-center justify-between gap-3">
                ...
                <span id='TimeErr' className='text-sm text-red-600 hidden'>Nazwa urzytkownika musi zawierać przynajmniej 3 litery</span>
              ...
              <SelectMenu workers = {workers} setWorkerId={setWorkerId}/>
