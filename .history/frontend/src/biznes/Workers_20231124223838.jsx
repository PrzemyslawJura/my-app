  ...
  return (
    <>
        <div className="w-3/5 m-auto my-1 ">
          <h1 className="text-2xl font-bold tracking-tight sm:text-2xl">Pracownicy</h1>
            <ul role="list" className="divide-y divide-gray-100">
              {workers.map((person) => (
                <>
                <li key={person.id} className="flex justify-between gap-x-6 py-5 bg-slate-100 rounded-md p-3">
