...
const reviews = { href: '#', average: 3.5, totalCount: 117 }
      ...
      <div className="pt-6">
        ...
        <div className="mx-auto max-w-2xl px-4 pb-16 pt-10 sm:px-6 ">
          <div className="lg:col-span-2 lg:border-r lg:border-gray-200 lg:pr-8">
            ...
            <h3 className="text-xl font-semibold tracking-tight text-gray-600">{product.city}, {product.street}, {product.code}</h3>
          </div>

          {/* Options */}
{/*} lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8 lg:pb-24 lg:pt-16
