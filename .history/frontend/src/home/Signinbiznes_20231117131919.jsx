...
const componentDidMount = () => {
  const requestOptions = {
      method: 'POST',
      headers: { 'Content-Type': 'multipart/form-data', 'Expires': '<http-date>' },
      body: JSON.stringify(   'Name=asdasd',
                              'Address.CityName=asdasd',
                              'Address.ZipCode=123',
                              'Photo.Photo=@main-image.jpg;type=image/jpeg',
                              'PhoneNumber=123456789',
                              'Address.LocalNumber=1232',
                              'Email=asdasd',
                              'Description=asdasda',
                              'Address.Street=asdasd',
                              'Photo.IsMain=true')};
  fetch('https://localhost:7230/api/City', requestOptions)
