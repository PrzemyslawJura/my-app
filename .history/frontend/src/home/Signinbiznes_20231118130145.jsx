...
const SigninBiznes = ({ setIsShown }) => {
  ...
  return (
    ...
    <form onSubmit={handleSubmit}>
      ...
      <span id='DescriptionErr' className='text-sm text-red-600 hidden'>Podano nie właściwe dane</span>
      <span id='DescriptionErr' className='text-sm text-green-600 hidden'>Pomyślnie utworzono konto salonu</span>
