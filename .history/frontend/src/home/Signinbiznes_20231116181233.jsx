...
const SigninBiznes = ({ setIsShown }) => {
  return (
    ...
    <div className="md:top-2/4 md:left-2/4 md:translate-x-[-50%] md:translate-y-[-50%] h-auto bg-white rounded-lg fixed flex flex-1 flex-col justify-center px-6 py-12 lg:px-8">
    <form>
    <XMarkIcon
