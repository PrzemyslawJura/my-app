...
const Login = ({ setIsShown }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    var result = fetch('https://localhost:7230/api/Identity/GetByEmailId?email='+ email)
    .then((res) => res.json())
    .then((result) => {
      console.log(result);
    ...
    result.then((resolvedSalonId) => {
      console.log(resolvedSalonId);
    });
    ...
    else if(salonId == null && userId != null)
    {
      navigate("/pracownicy");
    }
  }
