...
const SigninBiznes = ({ setIsShown }) => {
  return (
    ...
    <div className="lg:top-2/4 lg:left-2/4 lg:translate-x-[-50%] lg:translate-y-[-50%] h-auto bg-white rounded-lg fixed flex flex-1 flex-col justify-center px-6 py-12 lg:px-8">
    <form>
    <XMarkIcon
