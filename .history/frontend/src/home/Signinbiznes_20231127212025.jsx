...
const registerBiznes = async (email, password) => {
  try
  {
...
const SigninBiznes = ({ setIsShown }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setUserName(email)
      await registerBiznes(email, password, userName, salonId)
          ...
          <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            <div className="sm:col-span-4">
              ...
              <div className="mt-2">
                ...
                <span id='PasswordErr' className='text-sm text-red-600 hidden'>Nazwa salonu musi zawierać przynajmniej 2 znaki</span>
              </div>
            </div>
