        ...
        <div className="border-b border-gray-900/10 pb-12">
          ...
          <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            ...
            <div className="sm:col-span-3">
              ...
              <span id='Address.CityNameErr' className='text-sm text-red-600 hidden'>Email nie poprawny</span>
            </div>
            ...
            <div className="col-span-3">
              ...
              <span id='Address.StreetErr' className='text-sm text-red-600 hidden'>Email nie poprawny</span>
            </div>
            ...
            <div className="sm:col-span-2">
              ...
              <span id='Address.LocalNumber' className='text-sm text-red-600 hidden'>Numer lokalu nie może być pusty</span>
            </div>
            ...
            <div className="sm:col-span-2">
              ...
              <span id='Address.ZipCode' className='text-sm text-red-600 hidden'>Kod pocztowy nie poprawny</span>
            </div>
          </div>
        </div>
      </div>
