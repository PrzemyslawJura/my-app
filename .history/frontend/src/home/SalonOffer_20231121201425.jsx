...
return (
    <>
        ...
        <p className="mt-1 truncate text-xs leading-5 text-gray-500">Adres: {person.address.city.cityName}, ul.{person.address.city.street} {person.address.city.localNumber}, {person.address.city.zipCode}</p>
