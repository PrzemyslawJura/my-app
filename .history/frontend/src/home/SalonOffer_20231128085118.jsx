...
return (
    <>
        ...
        {isShown == 6 && <StepOne setDate={setDate} setTime={setTime} setIsSteps={setIsSteps} />}
        {isShown == 7 && <StepTwo serviceId={id} Date={date} Time={time} person={person} setIsSteps={setIsSteps}/>}
        {isShown == 8 && <StepOne setIsSteps={setIsSteps} />}
    </>
)}