...
return (
    <>
        ...
        {isShown == 6 && <StepOne setDate={setDate} setTime={setTime} setIsSteps={setIsShown} />}
        {isShown == 7 && <StepTwo serviceId={id} Date={date} Time={time} person={person} setIsSteps={setIsShown}/>}
        {isShown == 8 && <StepOne setIsSteps={setIsShown} />}
    </>
)}