        ...
        <div className="top-2/4 left-2/4 translate-x-[-50%] translate-y-[-50%] h-auto bg-white w-96 rounded-lg fixed flex flex-1 flex-col justify-center px-6 py-12 lg:px-8">
          ...
          <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <span id='ErrorValidation' className='text-sm text-red-600'>Podano nie właściwe dane</span>
              <span id='SuccesfullyValidation' className='text-sm text-green-600'>Pomyślnie utworzono konto salonu</span>
